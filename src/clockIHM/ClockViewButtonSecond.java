...
public class ClockViewButtonSecond extends ClockView {

	public ClockViewButtonSecond(String label, ClockModel tm, ClockController tc, int posX, int posY) {
	...
	public HBox creerLigneTexte() {
		...
		Text text = new Text("   " + String.valueOf(myModel.getSecond()));
